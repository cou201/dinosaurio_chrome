...
function Update() {
    ...
    if (score >= 5 && jugadorMuerto && !mensajeGanasteMostrado) {
        MostrarMensaje("¡Ganaste!");
        mensajeGanasteMostrado = true; // Marcar el mensaje como mostrado
    } else if (score < 5 && parado) {
        MostrarMensaje("¡Perdiste!");
        jugadorMuerto = true; // Marcar al jugador como muerto
    }
}
